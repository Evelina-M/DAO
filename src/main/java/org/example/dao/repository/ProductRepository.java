...
public class ProductRepository {
    ...
    private final String scriptProductName = read("select_product_name.sql");
    ...
    public List<String> getProductName(String name) {
        return namedParameterJdbcTemplate.queryForList(scriptProductName, Map.of("name", name), String.class);
    }
